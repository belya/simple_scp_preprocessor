...
function BasicOperator(type) {
  Operator.call(this);
  this.id = BasicOperator.counter;
  BasicOperator.counter++;
  this.type = type;
  this.arguments = [];
  this.transitions = [];
  this.additionalInfo = "";
...
/**
  Represents SimpleArgument with random unique name
  @constructor
*/
function RandomArgument() {
  SimpleArgument.call(this, "_argument" + RandomArgument.counter);
  RandomArgument.counter++;
}
RandomArgument.counter = 0;
/**
